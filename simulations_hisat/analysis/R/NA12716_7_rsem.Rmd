...
```{r}
# TODO: remember to remove the index below
...
This next plot shows performance on mean of median relative difference:
...
cufflinks_tophat_times <- load_timings(20, "Cufflinks\n+\nTopHat",
  "cufflinks_tophat.json", 'quant')
cufflinks_hisat_times <- load_timings(20, "Cufflinks\n+\nHISAT",
  "cufflinks_hisat.json", 'quant')
express_times <- load_timings(20, "eXpress", "express.json", 'quant')
rsem_times <- load_timings(20, "RSEM", "rsem.json", 'quant')
...
```{r}
tophat_times <- load_timings(20, "Cufflinks\n+\nTopHat", "tophat.json", 'align')
hisat_times <- load_timings(20, "Cufflinks\n+\nHISAT", "hisat.json", 'align')
bwt2_times <- load_timings(20, "eXpress", "bwt2.json", 'align')
bwt2_rsem_times <- load_timings(20, "RSEM", "bwt2_rsem.json", 'align')
```
...
plot_times <- bind_rows(
  parallel_times,
  bwt2_times,
  filter(all_times, grepl('Top|HI|RSE|fish|mon', method)))
```
